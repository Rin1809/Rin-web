...
const ProjectPage: React.FC = () => {
    ...
    const handleNext = () => {
        if (currentPage < totalPages) {
            ...
            window.scrollTo({ top: 500, behavior: 'smooth' }); // Cuon lai len dau danh sach cho do moi tay
        }
    };
    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.container}>
                ...
                {/* Header phan Du an moi nhat (Co Tabs loe loet) */}
                ...
                {/* Danh sach du an (Kho bau khoe ra day) */}
                            ...
                            <div className={styles.projectContent}>
                                <div className={styles.projectHeader}>
                                    ...
                                    <div className={styles.actionButtons}>
                                        ...
                                        {/* Link Github cho ai thich soi code */}
